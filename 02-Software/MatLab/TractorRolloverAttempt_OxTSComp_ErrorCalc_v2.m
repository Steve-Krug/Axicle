...
tau_s = 22; % Time constant, seconds, needs to be long enough to filter out any aggressive lateral acceleration maneuvers
...
figure(13)
hold on
title('OxTS Ext. Kalman vs. Axicle Complementary Tau = 22')
