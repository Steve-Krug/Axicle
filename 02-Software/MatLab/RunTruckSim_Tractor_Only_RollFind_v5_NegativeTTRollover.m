%% Title: RunTruckSim_Tractor_Only_RollFind_v5_NegativeTTRollover.m
% 9/3/23
% S. Krug
% Notes:
...
%
% 9/18/23 - Does not save all tractor sim data because runs are too large.
%
...
% Must first have a tractor trailer sim.
clc
clear
close all
...
load('C:\Users\SteveKrug\Documents\TruckSim\05-Trucksim_DesktopDatabase\Results\230921_JTurn_n3654_v1.mat')
...
simSlow1 = 0;
simSlow2 = 0;
lowerRollAngleThreshold_deg = 10;
            ...
            elseif index == indexOld
                while index == indexOld
                    ...
                    if simSlowFlag1 == 2
                        ...
                        disp('Sim failed after 2 attempts. Break to next configuration.')
