function [maxRollAngle_deg, allTractorData] = FindLimitRollAngle_v1(dataMatrix, lowerRollAngleThreshold_deg, upperRollAngleThreshold_deg)
%Steve Krug
%9/3/23
...
for rollThreshold = lowerRollAngleThreshold_deg:upperRollAngleThreshold_deg %iterate at increasing roll angles in increments of 1 deg
    ...
    allTractorData{fileCounter} = readtable(filename(end));
    ...
    if min(tractorDataMatrix(:,9)) < -tractorRollThreshold_deg
