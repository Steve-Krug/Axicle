...
time_sbg_zeroed_s = (sbgData.TimeStamp - sbgData.TimeStamp(end)) + 5.470;
...
plot(time_sbg_zeroed_s, sbgData.Roll, time_zeroed_s, thetaX_deg_complementary, time_zeroed_s, thetaX_deg_fromAccel, time_zeroed_s, thetaX_deg_C_HP)
legend('SBG', 'ASM Complementary, Tau = 75', 'ASM Estimate from Accel', 'High Pass Complementary')
% xlim([-7278 -7266])
xlabel('Time [s]')
