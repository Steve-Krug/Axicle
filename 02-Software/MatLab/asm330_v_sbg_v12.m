...
tau_s_hp = [.0000001 0.0001];

options = optimset('Display', 'iter');
fun = objectiveFunction_v1(time_s_clipped, Wx_dps_clipped, Ay_g_clipped, Az_g_clipped, tau_s, tau_s_hp, sbgRoll_deg_clipped);

x = fminsearch(@fun, tau_s_hp, options);

function [error] = objectiveFunction_v1(time_s_clipped, Wx_dps_clipped, Ay_g_clipped, Az_g_clipped, tau_s, tau_s_hp, sbgRoll_deg_clipped)

[thetaX_accel, thetaX_comp_deg, thetaX_LP_deg, thetaX_HP_deg] = Rate2Angle_Complementary_HP_v4(time_s_clipped, Wx_dps_clipped, Ay_g_clipped, Az_g_clipped, tau_s, tau_s_hp);

errorRMSE = rmse(thetaX_HP_deg, sbgRoll_deg_clipped);
