...
time_sbg_zeroed_s = (sbgData.TimeStamp - sbgData.TimeStamp(1)) + (2.4830) +(413.979-409.281);
...
% [thetaX_accel, thetaX_comp_deg, thetaX_LP_deg, thetaX_HP_deg] = Rate2Angle_Complementary_HP_v6(time_s_clipped, Wx_dps_clipped, Ay_g_clipped, Az_g_clipped, tau_s, tau_s_hp);
% 
...
grid on
ylabel('Angle [deg]')
legend('SBG Angle Est. "Truth"','9sec Moving Average Rate Filter')
subplot(3,1,2)
...
ylabel('Angle [deg]')
subplot(3,1,3)
plot(time_s_clipped(5001:end),rateDrift)
xlim([lowerClip_s upperClip_s])
legend('Rate Drift')
