...
tau_s_1 = 120; % Time constant, seconds, needs to be long enough to filter out any aggressive lateral acceleration maneuvers
tau_s_2 = 40;
tau_s_3 = 30;
% alpha = 1 - exp(-dt/tau_s); % Alpha for 1st order filter

alpha_1 = 1 - exp(-dt/tau_s_1);
alpha_2 = 1 - exp(-dt/tau_s_2);
alpha_3 = 1 - exp(-dt/tau_s_3);
