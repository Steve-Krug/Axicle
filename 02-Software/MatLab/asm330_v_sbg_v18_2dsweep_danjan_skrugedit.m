...
GNCConstants.Gravity_mps2 = 9.81
...
tau_s_hp = 30;
tau_s = 1000;
[thetaX_accel, thetaX_comp_deg, thetaX_LP_deg, thetaX_HP_deg, angleAccelRaw, anglePureIntegration, gyroLP, gyroHP] = Rate2Angle_Complementary_HP_v11_danjan_skrugedit(time_s_clipped, Wx_dps_clipped, sbgWx_dps_clipped, Ay_g_clipped, Az_g_clipped, tau_s, tau_s_hp);

% I think sign of accel angle might be backwards

figure(4)
plot(time_s_clipped, sbgRoll_deg_clipped, time_s_clipped, gyroLP, time_s_clipped, anglePureIntegration, time_s_clipped, thetaX_comp_deg)
grid on
ylabel('Angle [deg]')
legend('SBG Angle Est. "Truth"', 'gyro low pass', 'Angle Pure Integration', 'Complementary')
