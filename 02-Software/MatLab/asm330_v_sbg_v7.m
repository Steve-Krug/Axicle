...
time_sbg_zeroed_s = (sbgData.TimeStamp - sbgData.TimeStamp(1)) + (5.470-4.038) - 4.05;
...
%Create time series object to make SBG data same rate as ASM330 data.

thetaX_deg_complementary_HP = Rate2Angle_Complementary_HP_v1(time_zeroed_s, Wx_dps, Ay_g, Az_g, tau_s, freq_hz);

% rmse(thetaX_deg_complementary_HP, sbgData.Roll
...
plot(time_sbg_zeroed_s, sbgData.Roll, time_zeroed_s, thetaX_deg_complementary_HP)
