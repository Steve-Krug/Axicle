...
lowerClip_s = 520; %section with 2deg static dwell
upperClip_s = 640;
...
%  [~, ~, ~, thetaX_HP_deg] = Rate2Angle_Complementary_HP_v11(time_s_clipped, Wx_dps_clipped, Ay_g_clipped, Az_g_clipped, tau_s(i), tau_s_hp);
