function [angleComp, angleAccel] = Rate2Angle_Complementary_HP_v8(time_s, rate_dps, Ay_g, Az_g, tau_s, tau_s_hp)
% Rate2Angle_v6.m
% 1/24/24
% S. Krug
...
for i = 2:length(rate_dps)
    ...
    % thetaX_deg_fromAccel_test = atand(Ay_g(i)/Az_g(i));
    ...
    thetaX_deg_fromIntegration(i) = ( thetaX_deg_comp(i-1) + rate_dps(i)*dt ); %Pure integration
