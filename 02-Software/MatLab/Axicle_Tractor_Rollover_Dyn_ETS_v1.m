...
%% Mass Properties
g_mps2 = 9.81;
slack_angle = 15; %angle in deg when tractor inertia is added on, and tractor plus trailer roll together at same rate.
%Tractor
...
for t = 1:length(time_s)-1
    ...
    if (TRAIL_roll_angle_rad(t)*57.29) < slack_angle %get the trailer up to speed first
        ...
        TOTAL_tq_nm(t) = (TRAIL_force_drag_N*TRAIL_d_cp_y_m(t))-(TRAIL_force_weight_N*TRAIL_d_cg_x_m(t))+...
            (TRAC_force_drag_N*TRAC_d_cp_y_m(t))-(TRAC_force_weight_N*TRAC_d_cg_x_m(t));
        ...
        if (TRAIL_roll_angle_rad(t+1)*57.29) > 90
            break
        end
