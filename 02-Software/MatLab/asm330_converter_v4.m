...
load('C:\Users\SteveKrug\OneDrive - Axicle\Public\15. GitHub Repo\Axicle\02-Software\MatLab\AxicleDeskTest1.mat')
...
parfor i = 1:length(time_parse1)
    ...
    if strlength(data_parse1(i,1))  > 62
        ...
        accels(i,:) = (parse_int16_v1(accel_reg{i,1})*dps)/32678;
