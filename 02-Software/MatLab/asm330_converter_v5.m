...
% Read table first, save "data" as .mat, file, then reload:
% data = readtable('C:\Users\slkru\OneDrive - Axicle\Public\15. GitHub Repo\Axicle\02-Software\MatLab\AxicleExport_554pm_Jan20_Hindry_NoLeverArm_NoGPS.log'); %opens as cell array

load('C:\Users\slkru\OneDrive - Axicle\Public\15. GitHub Repo\Axicle\02-Software\MatLab\AxicleExport_554pm_Jan20_Hindry_NoLeverArm_NoGPS.mat')

time_parse1 = data.x_2024_01_20T17_34_22_390;
minuteOffset = 0; %sec
data_parse1 = data.x0x1E_0x04;
