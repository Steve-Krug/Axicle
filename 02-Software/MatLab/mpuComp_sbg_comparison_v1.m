...
load('240232_mpubench_v2.mat'); %Must first open .txt data in excel, then paste 7 columns into matlab. save varaible as "mpuData".


sbgData = readtable('240213_SBGbenchtest_v2.txt');
