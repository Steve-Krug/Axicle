...
// Complementary Vars
float tau_s_hp = 18; //15-20 is typical
float tau_s = 500; // 1000 is typical
float tau_s_lp = .001; //0.0001 is typical
...
void loop() {
    ...
    // otherwise, check for DMP data ready interrupt (this should happen frequently)
        ...
        fifoCount -= packetSize;
            ...
            if (printSerialValue == LOW){
              Serial.print("RollPitchYaw_rate\t,");
...
if(printSerialValue == HIGH){
              //Serial.print("Complementary Roll Angle\t");
              Serial.print("Complementary Roll Angle:");
              Serial.print(thetaX_Complementary_deg);
              Serial.print(",\t");
              Serial.print("Accel Roll Angle\t");              
              Serial.print(thetaX_Accel_deg);
              Serial.print(",\t");
              Serial.println();
}
