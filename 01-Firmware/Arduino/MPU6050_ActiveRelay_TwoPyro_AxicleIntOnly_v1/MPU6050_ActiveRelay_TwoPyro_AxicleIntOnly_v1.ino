...
if(printSerialValue == LOW){
              ...
              //Serial.print("CA,\t");
              Serial.print(thetaX_Integration_HP_deg);Serial.print(",\t");
              //Serial.print("AA\t");            
...
// ===                        Firing Logic                      ===
        ...
        roll_rate_allowed1 = multiMap<int16_t>(abs(thetaX_Integration_HP_deg), roll_angle_in1, roll_rate_out1, 3); // Replaced ypr[rollIdx] with complementary filtered roll angle.
