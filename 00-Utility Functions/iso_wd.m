function y = iso_wd(x,fs) 
% the code is used for horizonal direction general vehicle vibration
% refer ISO 2631- horizonal acceleration discomfort filter(x,y), 
% when acceleration mounted on the seat surface.
% ISO 2631-4

    
% Filter ISO wd, whole body, vertical direction  
...
if f2>200
    [b2,a2] = butter(2,f2/nyq);       % Low pass % determine parameters for a-v transition 
end
B3 = [1/w3 1]; A3 = [1/w4/w4 1/Q4/w4 1]; 
[b3,a3] = bilinear(B3,A3,fs); % determine parameters for upward step 
