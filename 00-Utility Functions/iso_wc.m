function y = iso_wc(x,fs) 
% the code is used for horizonal direction general vehicle vibration
% refer ISO 2631- horizonal acceleration discomfort filter.
% ISO 

    
% Filter  Wk, whole body, in latter and fore/aft direction, when
% accelerometers mounted on the seat back
